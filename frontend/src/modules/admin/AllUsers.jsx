...
const AllUsers = () => {
   ...
   const getAllUser = async () => {
      try {
         const response = await axios.get('https://house-rent-qr83.onrender.com/api/admin/getallusers', {
   ...
   const handleStatus = async (userid, status) => {
      try {
         await axios.post('https://house-rent-qr83.onrender.com/api/admin/handlestatus', { userid, status }, {
            headers: { 'Authorization': `Bearer ${localStorage.getItem("token")}` }
         }).then((res) => {
            if (res.data.success) {
               getAllUser();
